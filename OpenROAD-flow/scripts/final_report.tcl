...
if {[env_var_exists_and_non_empty RCX_RULES]} {
  ...
  if {[env_var_exists_and_non_empty SKIP_IR_DROP_CHECK]} {
    puts "skip IR Drop analysis"
  } elseif {[env_var_exists_and_non_empty PWR_NETS_VOLTAGES]} {
  ...
  if {[env_var_exists_and_non_empty SKIP_IR_DROP_CHECK]} {
    puts "skip IR Drop analysis"
  } elseif {[env_var_exists_and_non_empty GND_NETS_VOLTAGES]} {
...
# save_image $::env(RESULTS_DIR)/00_final_placement.png
